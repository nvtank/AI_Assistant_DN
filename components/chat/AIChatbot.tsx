          ...
          <div className="border-t border-white/30 bg-white/50 p-3 sm:p-4 flex-shrink-0">
            <div className="flex gap-2 sm:gap-3 min-w-0">
              ...
              <button
                ...
                className="flex-shrink-0 group relative px-3 sm:px-6 py-2.5 sm:py-3 bg-grab-green text-white rounded-lg hover:bg-[#009640] transition-all duration-200 disabled:opacity-40 disabled:cursor-not-allowed text-sm sm:text-base font-semibold shadow-md hover:shadow-lg overflow-hidden min-w-[44px] sm:min-w-0"
                title="Send message"
              >
