        ...
        <div className="flex-1 p-3">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-2 text-xs text-gray-500">
              ...
              {place.isIndoor && <span className="text-blue-600">🏠 Indoor</span>}
            </div>

            <button
              onClick={handleBookGrab}
              className="px-3 py-1 bg-grab-green text-white text-xs font-semibold rounded-full hover:bg-green-600 transition-colors flex items-center gap-1"
            >
              <span>🚗</span>
              <span>Book Grab</span>
            </button>
