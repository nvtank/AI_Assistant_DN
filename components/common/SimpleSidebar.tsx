    ...
    <aside className={`h-screen bg-white border-r border-gray-200 transition-all duration-300 flex flex-col fixed left-0 top-0 z-50 shadow-sm ${isOpen ? 'w-64' : 'w-16'}`}>
      ...
      {isOpen ? (
        ...
        <div className="flex-1 flex flex-col items-center py-4 gap-4">
          <button 
            onClick={() => setActiveTab('chat')}
            className={`w-10 h-10 rounded-lg flex items-center justify-center shadow-md hover:shadow-lg transition-all duration-200 ${
              activeTab === 'chat' 
                ? 'bg-grab-green text-white hover:bg-[#009640]' 
